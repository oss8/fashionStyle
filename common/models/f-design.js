...
module.exports = function (Fdesign) {
    ...
    Fdesign.GetTypeversionResources = function (baseInfo, cb) {
        ...
        Promise.all(pv).then(function () {
            ...
            _A.color = _colorVersion.Result;
            _A.pattern = _publicImage.Result;
            result.data.A = _A;
            ...
            _B.color = _colorVersion.Result;
            _B.pattern = _publicImage.Result;
    ...
    Fdesign.remoteMethod(
        'GetTypeversionResources',
        {
            ...
            accepts: { arg: 'baseInfo', type: 'object', description: '{"Gender":"A","Typeversion":"00"}' },
